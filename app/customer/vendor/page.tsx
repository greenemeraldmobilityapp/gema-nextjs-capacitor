...
import { ArrowLeft, Star, MapPin, CheckCircle, ShieldCheck, Clock } from 'lucide-react';
...
function VendorDetailContent() {
  ...
  const services = [
    { id: 's1', title: 'Perbaikan AC Bocor', price: 'Rp 150.000', duration: '1-2 Jam' },
    { id: 's2', title: 'Cuci AC Reguler', price: 'Rp 75.000', duration: '45 Menit' },
    { id: 's3', title: 'Pemasangan AC Baru', price: 'Rp 350.000', duration: '2-3 Jam' },
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 pb-24">
      ...
      <div className="bg-white p-4 pb-6 border-b shadow-sm">
        <div className="flex gap-4 items-start">
          ...
          <div className="flex-1">
            <h1 className="text-xl font-bold text-gray-900 leading-none mb-1">Budi Teknik</h1>
            <p className="text-emerald-600 font-medium text-sm mb-2">Teknisi Listrik & AC</p>
        ...
        <div className="mt-6 flex items-center justify-around p-3 bg-emerald-50 rounded-xl">
          <div className="flex flex-col items-center">
            ...
            <span className="text-xs font-bold text-emerald-800">Terverifikasi</span>
          </div>
          <div className="w-px h-8 bg-emerald-200"></div>
          <div className="flex flex-col items-center">
            <CheckCircle size={24} className="text-emerald-600 mb-1" />
            <span className="text-xs font-bold text-emerald-800">100+ Proyek</span>
          </div>
          <div className="w-px h-8 bg-emerald-200"></div>
          <div className="flex flex-col items-center">
            <Clock size={24} className="text-emerald-600 mb-1" />
            <span className="text-xs font-bold text-emerald-800">Sangat Cepat</span>
          </div>
        </div>
      </div>
            ...
            <Card key={service.id} className="rounded-xl overflow-hidden cursor-pointer hover:border-emerald-500 transition-colors shadow-sm border-none">
              <CardContent className="p-4">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="font-bold text-emerald-600 shrink-0">{service.price}</span>
                </div>
                <div className="flex justify-between items-end">
                  <span className="text-xs font-medium text-gray-500 bg-gray-100 px-2 py-1 rounded-md">{service.duration}</span>
      ...
      {/* Portfolio / Reviews could go here */}
    </div>
  );
}
