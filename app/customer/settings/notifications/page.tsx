...
import { ArrowLeft, Bell, MessageSquare, Tag, ShieldCheck } from 'lucide-react';
  ...
  const sections = [
    {
      ...
      items: [
        { key: 'orders' as const, icon: Bell, label: 'Status Pesanan', desc: 'Update saat tukang tiba atau selesai', color: 'bg-blue-50 text-blue-600' },
        { key: 'chat' as const, icon: MessageSquare, label: 'Pesan Masuk', desc: 'Saat mitra mengirimkan pesan', color: 'bg-green-50 text-green-600' },
      ]
    },
    {
      title: 'Promosi & Info',
      items: [
        { key: 'promo' as const, icon: Tag, label: 'Promo & Penawaran', desc: 'Diskon spesial GEMA', color: 'bg-orange-50 text-orange-600' },
        { key: 'system' as const, icon: ShieldCheck, label: 'Info Akun', desc: 'Keamanan & perubahan akun', color: 'bg-purple-50 text-purple-600' },
      ]
    }
  ];
